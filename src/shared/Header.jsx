...
const Header = () => {
  ...
  const handleDownload = () => {
    ...
    link.download = "Melwen_Resume.pdf";
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-white ps-10 pe-10 pt-5 pb-2 ">
        <div className="flex justify-between items-center font-semibold ">
          <div
            ...
            onClick={() => handleScroll("landingPageSection")}
          >
            {" "}
            <img src="logo-personal.svg" alt="" /> Who Am I?
          </div>
          ...
          <div className="hidden md:flex md:items-center">
            <div className="lg:absolute lg:left-1/2 lg:transform lg:-translate-x-1/2">
              <ul className="flex gap-10 font-semibold cursor-pointer">
                ...
                <li onClick={() => handleScroll("myProjectSection")}>
                  Project
                </li>
                <li onClick={() => handleScroll("contactMeSection")}>
                  Contact me
                </li>
              </ul>
            </div>
            <button
              className="bg-black text-white p-3 rounded-md ml-10"
        ...
        {/* Mobile Menu */}
        <div
          className={`md:hidden fixed top-0 right-0 h-full w-1/2 bg-black text-white shadow-lg transform transition-transform duration-300 ease-in-out z-50 ${
        ...
        >
          <div className="p-4">
            ...
            <button
              className="bg-white text-black p-3 rounded-md mt-4 w-full"
              onClick={handleDownload}
            >
              Resume&nbsp;&nbsp;
